                    ...
                    if ($gambar) {
                        foreach ($gambar as $gambar) {
                            ...
                            <div class="item-slick3" data-thumb="<?= base_url('assets/upload/image/thumbs/' . $gambar->gambar) ?>">
                                <div class="wrap-pic-w">
                                    <img src="<?= base_url('assets/upload/image/thumbs/' . $gambar->gambar) ?>" alt="<?= $gambar->judul_gambar ?>">
                                </div>
                            </div>
                    ...
                    <div class="item-slick2 p-l-15 p-r-15">
                        ...
                        <div class="block2">
                            <div class="block2-img wrap-pic-w of-hidden pos-relative block2-labelnew">
                                <img src="<?= base_url('assets/upload/image/thumbs/' . $produk_related->gambar) ?>" alt="<?= $produk_related->nama_produk ?>" width="200">
                            ...
                            <div class="block2-txt p-t-20">
                                ...
                                <span class="block2-price m-text6 p-r-5">
                                    $ <?= number_format($produk_related->harga, '0', ',', '.') ?>
                                </span>
                            </div>
                        </div>
                        <?= form_close(); ?>
