        ...
        foreach ($rekening as $rekening) { ?>
            <tr>
                ...
                <td>
                    ...
                    <a href="<?= base_url('admin/rekening/hapus/' . $rekening->id_rekening); ?>" class="btn btn-danger btn-xs" onclick="return confirm('Beneran Bre?')"><i class="fa fa-trash-o"></i>Hapus</a>
                </td>
            </tr>
        <?php } ?>
    </tbody>
